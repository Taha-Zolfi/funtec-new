// مسیر: src/app/[locale]/Home/FerrisWheel.jsx
...
// [مهم] دریافت locale به عنوان prop
function FerrisWheel({ locale }) {
  ...
  // ... (سایر هوک‌ها و توابع بدون تغییر باقی می‌مانند)
  ...
  // [FIX] منطق جاوااسکریپت برای تعیین موقعیت بر اساس زبان
  const positionX = locale === 'en' ? 0.7 : -1.2;

  return <primitive object={scene} ref={groupRef} position={[positionX, 0.1, 0]} />;
}
